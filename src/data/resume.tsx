...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      GitHub: {
        url: "https://github.com/jacksonllk",
        icon: Icons.github,
      },
      LinkedIn: {
        url: "https://linkedin.com/in/jacksonllk",
        icon: Icons.linkedin,
      },
      X: {
        url: "https://x.com/jackson_llk",
        icon: Icons.x,
      },
    },
  },
  ...
  work: [
    {
      ...
      description:
        "Construction company specializing in civil and infrastructure works, building construction, and housing development.",
    },
    {
      company: "Grandee Development Sdn Bhd",
      badges: [],
      href: "",
      location: "Malaysia",
      title: "Director",
      ...
      description:
        "Construction company specializing in civil works, building construction, and infrastructure development.",
    },
    {
      company: "Kim Bradbury Chartered Accountant",
      href: "",
      badges: [],
      location: "Perth, WA",
